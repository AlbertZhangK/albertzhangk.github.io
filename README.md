...
<head>
  ...
  <meta name="description" content="Personal website of Kai Zhang, Ph.D. candidate at Peking University and Visiting Scholar at Harvard Kennedy School. Researching Tocqueville, political theory, and critical theory." />
  <style>
    * {
    ...
    .intro-section {
      display: flex; /* 补上了 flex，让照片和文字并排显示更自然 */
      gap: 30px;
      margin-bottom: 20px;
    }
...
<body>
  ...
  <div class="intro-section">
    <img src="4b932ec969a40718bec70946dda41b86.jpeg" alt="Photo of Kai Zhang" />
    <div class="intro-text">
      <h1 class="zh" style="display:none">张开</h1>
      <h1 class="en">Zhang Kai</h1>
  ...
  <div class="section">
    <h2 class="zh" style="display:none">教育经历</h2>
  ...
  <div class="section">
    <h2 class="zh" style="display:none">科研成果</h2>
    <h2 class="en">Publications</h2>
    <ol>
      <li>
  ...
  <div class="section">
    <h2 class="zh" style="display:none">会议发言</h2>
    <h2 class="en">Conference Presentations</h2>
    <ol>
  ...
  <script>
    function toggleLang() {
      ...
      // 因为现在初始状态是 zh 隐藏 (display:none)，en 显示 (无 inline style)
      // JS 逻辑保持不变，依然能完美翻转
